-- Keep mixed-group uniqueness out of request handling.
-- This migration removes historical duplicate rows first, then creates the
-- indexes that normal runtime writes can rely on.
